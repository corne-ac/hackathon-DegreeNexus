  ...
  <svelte:fragment slot="header">
    ...
    <AppBar>
      <svelte:fragment slot="lead">
        ...
        <a href="/degrees" class="relative flex items-center justify-center h-12 w-12 mt-2 mb-2 mx-2 variant-soft-primary hover:bg-opacity-100 text-primary-500 hover:variant-filled-primary hover:text-white rounded-3xl hover:rounded-xl transition-all duration-200 ease-linear group">
          ...
          <span class="absolute w-auto p-2 m-2 min-w-max top-12 rounded-md shadow-md variant-filled-primary text-sm font-bold transition-all duration-100 scale-0 origin-top group-hover:scale-100">
            Degrees
          </span>         
        </a>

        <a href="/" class="relative flex items-center justify-center h-12 w-12 mt-2 mb-2 mx-2 variant-soft-primary hover:bg-opacity-100 text-primary-500 hover:variant-filled-primary hover:text-white rounded-3xl hover:rounded-xl transition-all duration-200 ease-linear group">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
        ...
        <button use:popup={popupTheme} class="relative flex items-center justify-center h-12 w-12 mt-2 mb-2 mx-2 variant-soft-primary hover:bg-opacity-100 text-primary-500 hover:variant-filled-primary hover:text-white rounded-3xl hover:rounded-xl transition-all duration-200 ease-linear group">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
      ...
      <svelte:fragment slot="trail">
        ...
        <div class="flex title-font font-medium items-center mb-4 mx-4">
          ...
          {:else if true}
            <p class="mr-3"><a href="/auth/login" class="text-primary-600 hover:underline dark:text-primary-500">Login</a> or <a href="/auth/register/" class="text-primary-600 hover:underline dark:text-primary-500">Register</a> to get started!</p>
          {/if}
